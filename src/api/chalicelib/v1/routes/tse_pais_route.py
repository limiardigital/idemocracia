...
#
v1_tse_pais_routes = Blueprint(__name__)

#
service = tse_pais_resource_service.TsePaisResourceService()
...
#
@v1_tse_pais_routes.route('%(resource)s/{id}' % {'resource': util_resource.RESOURCE_URL_V1_TSE_PAIS}, methods=['GET'], cors=True)
def get_by_id(id):
...
#
@v1_tse_pais_routes.route('%(resource)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_PAIS}, methods=['GET'], cors=True)
def get_all():
...
#
@v1_tse_pais_routes.route('%(resource)s/{id}/%(sub_resource_fonte)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_PAIS, 'sub_resource_fonte': util_resource.RESOURCE_V1_TSE_CANDIDATURA}, methods=['GET'], cors=True)
...
#
@v1_tse_pais_routes.route('%(resource)s/{id}/%(sub_resource_fonte)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_PAIS, 'sub_resource_fonte': util_resource.RESOURCE_V1_TSE_FONTE}, methods=['GET'], cors=True)
