...
#
v1_tse_coligacao_partidaria_routes = Blueprint(__name__)

#
service = tse_coligacao_partidaria_resource_service.TseColigacaoPartidariaResourceService()
partido_service = tse_partido_resource_service.TsePartidoResourceService()
...
#
@v1_tse_coligacao_partidaria_routes.route('%(resource)s/{id}' % {'resource': util_resource.RESOURCE_URL_V1_TSE_COLIGACAO_PARTIDARIA}, methods=['GET'], cors=True)
def get_by_id(id):
...
#
@v1_tse_coligacao_partidaria_routes.route('%(resource)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_COLIGACAO_PARTIDARIA}, methods=['GET'], cors=True)
def get_all():
...
#
@v1_tse_coligacao_partidaria_routes.route('%(resource)s/{id}/%(sub_resource_fonte)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_COLIGACAO_PARTIDARIA, 'sub_resource_fonte': util_resource.RESOURCE_V1_TSE_PARTIDO}, methods=['GET'], cors=True)
def get_all_partido(id):
    ...
    try:
        ...
        #
        result = partido_service.find_all_by(
            origin_resource_path=app.app.current_request.context['path'],            
            page_number=query_param_page_number,
            page_size=query_param_page_size,
            id_coligacao_partidaria=path_param_id)
...
#
@v1_tse_coligacao_partidaria_routes.route('%(resource)s/{id}/%(sub_resource_fonte)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_COLIGACAO_PARTIDARIA, 'sub_resource_fonte': util_resource.RESOURCE_V1_TSE_CANDIDATURA}, methods=['GET'], cors=True)
...
#
@v1_tse_coligacao_partidaria_routes.route('%(resource)s/{id}/%(sub_resource_fonte)s' % {'resource': util_resource.RESOURCE_URL_V1_TSE_COLIGACAO_PARTIDARIA, 'sub_resource_fonte': util_resource.RESOURCE_V1_TSE_FONTE}, methods=['GET'], cors=True)
